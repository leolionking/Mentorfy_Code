...
export default function Dashboard() {
  ...
  return (
    <div>
      <div className="p-10">
        <h1 className="text-xl lg:text-3xl font-['ginto-bold']"> Welcome {userData?.firstName} 👏</h1>
        <p>Track and Manage your Mentorship Workspace</p>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
          <div className="card shadow-small p-6 rounded-lg bg-white">
        ...
        <div className="mt-5 grid md:grid-cols-[8fr,4fr]">
           <RecentSignup/>
        </div>
      </div>
    </div>
